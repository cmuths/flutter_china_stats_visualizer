...
import '../../../common_widgets/panel/panel_widgets.dart';
...
class MetricsTreeScreen extends StatefulWidget {
  const MetricsTreeScreen({super.key});

  @override
  State<MetricsTreeScreen> createState() => _MetricsTreeScreenState();
}

class _MetricsTreeScreenState extends State<MetricsTreeScreen> {
