...
class OneMetricsWidgets extends ConsumerWidget {
                        ...
                        Row(
                            ...
                            children: [
                                ...
                                Icon(
                                    ...
                                    size: 25,
                                    color: metricsDomain.unitIconColor ??
                                        metricsDomain.valueColor,
                                ),
                            ],
                        ),
                        AppFillBox.gapH8,
    ...
    List<Widget> _getCompareWidget(
        ...
        return [
            ...
            Transform.rotate(
                angle: pi,
                child: Icon(CupertinoIcons.arrowshape_turn_up_left_fill,
                    size: 15, color: unitColor ?? Colors.red.withOpacity(0.7))),
        ];
    }
}
