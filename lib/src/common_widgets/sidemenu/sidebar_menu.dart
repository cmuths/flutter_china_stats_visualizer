    ...
    with SingleTickerProviderStateMixin
{
    ...
    // 计算自适应高度，根据 IconButton 的数量和大小调整
    double _calculateAdaptiveHeight(BoxConstraints constraints)
    {
        // 假设每个 IconButton 的高度为 50，加上一些间距
        return 3 * 30.0 + 2 * 10.0; // 3 个 IconButton + 2 个间距
    }
}
